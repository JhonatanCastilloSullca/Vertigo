...
function Destinos() {
    ...
    const { data, loading, error } = useFetch("http://127.0.0.1/api/ubicaciones", requestOptions);
    ...
    return (
        <>
            <div className="ftco-section img ftco-select-destination pt-4" style={{ backgroundImage: "url('./assets/images/luxa.org-opacity-changed-Lago-Salvador-_Parque-Nacional-del-Manu-Juan-Carlos.webp')" }}>
