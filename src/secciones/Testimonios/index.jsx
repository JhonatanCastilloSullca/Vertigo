...
function Testimonios() {
    ...
    return (
        <>
            ...
            <div className="ftco-section testimony-section bg-bottom" style={{ backgroundImage: "url('./assets/images/Lago-Salvador-_Parque-Nacional-del-Manu-Juan-Carlos.webp')" }}>
