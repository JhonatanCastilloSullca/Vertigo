...
function PaquetePage() {
    ...
    const { data: paqueteData, loading, error } = useFetch(`http://127.0.0.1/api/ubicacion-slug?language_id=1&slug=${paqueteSlug}`, requestOptions);
    ...
    return (
        <>
            ...
            <div id="Tours"></div>
            <div className="ftco-section py-4" >
                <Container className="">
            ...
            <div className="ftco-section services-section pt-4 descriptio-tour-container pb-0">
